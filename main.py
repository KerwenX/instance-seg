...
def parse_args(args=None):
    ...
    parser.add_argument('--data_dir', default='/home/aston/Desktop/python/ROCA/Data/Dataset')
    parser.add_argument('--image_root', default="/home/aston/Desktop/python/ROCA/Data/Images")
    parser.add_argument('--rendering_root', default="/home/aston/Desktop/python/ROCA/Data/Rendering")
    parser.add_argument('--full_annot', default="/home/aston/Desktop/python/ROCA/Data/full_annotations.json")

    parser.add_argument('--output_dir', default='/home/aston/Desktop/python/ROCA/network/output')
    parser.add_argument('--override_output', default=1, type=int)
    ...
    parser.add_argument('--eval_only', default=1, type=int)
    parser.add_argument('--checkpoint', default='/home/aston/Desktop/python/ROCA/Models/model_best.pth')
...
def register_data(args):
    ...
    register_scan2cad(
        ...
        split='train',
        data_dir=data_dir,
        metadata={'scenes': path.abspath('/home/aston/Desktop/python/ROCA/metadata/scannetv2_train.txt')},
    ...
    register_scan2cad(
        ...
        split='val',
        data_dir=data_dir,
        metadata={'scenes': path.abspath('/home/aston/Desktop/python/ROCA/metadata/scannetv2_val.txt')},
        image_root=args.image_root,
        rendering_root=args.rendering_root,
        full_annot=args.full_annot
    )
