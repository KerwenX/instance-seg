...
class Predictor:
    def __init__(
        ...
        # =============our add==================
        del backup['model']['pixel_mean']
        del backup['model']['pixel_std']
        del backup['model']['proposal_generator.anchor_generator.cell_anchors.0']
        del backup['model']['proposal_generator.anchor_generator.cell_anchors.1']
        del backup['model']['proposal_generator.anchor_generator.cell_anchors.2']
        del backup['model']['proposal_generator.anchor_generator.cell_anchors.3']
        del backup['model']['proposal_generator.anchor_generator.cell_anchors.4']
        # ===================================
    ...
    def __call__(
        ...
        # ============================
        # import pickle
        # with open('3m_output.dat','wb') as f:
